...
* returns Object
* */
const createCertificatesV1alpha1ClusterTrustBundle = ({ body, dryRun, fieldValidation }) => new Promise(
...
* returns Object
* */
const deleteCertificatesV1alpha1ClusterTrustBundle = ({ name, dryRun }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const deleteCertificatesV1alpha1CollectionClusterTrustBundle = ({ dryRun }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        dryRun,
...
* returns Object
* */
const getCertificatesV1alpha1APIResources = () => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
      }));
...
* returns Object
* */
const listCertificatesV1alpha1ClusterTrustBundle = () => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
      }));
...
* returns Object
* */
const patchCertificatesV1alpha1ClusterTrustBundle = ({ name, dryRun, fieldValidation }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const readCertificatesV1alpha1ClusterTrustBundle = ({ name }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const replaceCertificatesV1alpha1ClusterTrustBundle = ({ name, body, dryRun, fieldValidation }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const watchCertificatesV1alpha1ClusterTrustBundle = ({ name }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const watchCertificatesV1alpha1ClusterTrustBundleList = () => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
      }));
