...
* @isObject
*/
glusterfs?: { path: string; readOnly?: boolean; endpoints: string; endpointsNamespace?: string };
/**
...
* @isObject
*/
storageos?: { readOnly?: boolean; secretRef?: { uid?: string; apiVersion?: string; fieldPath?: string; kind?: string; name?: string; namespace?: string; resourceVersion?: string }; volumeName?: string; volumeNamespace?: string; fsType?: string };
/**
* Represents a Ceph Filesystem mount that lasts the lifetime of a pod Cephfs volumes do not support ownership management or SELinux relabeling.
* @isObject
*/
cephfs?: { readOnly?: boolean; secretFile?: string; secretRef?: { name?: string; namespace?: string }; user?: string; monitors: string[]; path?: string };
/**
...
* @isObject
*/
csi?: { readOnly?: boolean; volumeHandle: string; controllerExpandSecretRef?: { name?: string; namespace?: string }; controllerPublishSecretRef?: { name?: string; namespace?: string }; driver: string; fsType?: string; nodePublishSecretRef?: { name?: string; namespace?: string }; nodeStageSecretRef?: { name?: string; namespace?: string }; nodeExpandSecretRef?: { name?: string; namespace?: string }; volumeAttributes?: Record<string, any> };
/**
...
* @isObject
*/
iscsi?: { chapAuthDiscovery?: boolean; chapAuthSession?: boolean; fsType?: string; initiatorName?: string; iqn: string; lun: number; readOnly?: boolean; iscsiInterface?: string; portals?: string[]; secretRef?: { name?: string; namespace?: string }; targetPortal: string };
/**
...
* @isObject
*/
scaleIO?: { system: string; volumeName?: string; fsType?: string; sslEnabled?: boolean; storageMode?: string; storagePool?: string; gateway: string; protectionDomain?: string; readOnly?: boolean; secretRef: { name?: string; namespace?: string } };
/**
