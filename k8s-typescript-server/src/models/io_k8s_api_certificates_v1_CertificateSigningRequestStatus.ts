...
*/
conditions?: Array<{ reason?: string; status: string; type: string; lastTransitionTime?: Date; lastUpdateTime?: Date; message?: string }>;
}

/**
* Create a new io_k8s_api_certificates_v1_CertificateSigningRequestStatus with default values
*/
