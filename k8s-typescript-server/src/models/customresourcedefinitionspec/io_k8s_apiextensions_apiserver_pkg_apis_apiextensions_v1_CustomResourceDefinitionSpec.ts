...
* @isArray
*/
versions: Array<{ deprecationWarning?: string; name: string; schema?: { openAPIV3Schema?: Record<string, any> }; served: boolean; storage: boolean; subresources?: { scale?: { statusReplicasPath: string; labelSelectorPath?: string; specReplicasPath: string }; status?: Record<string, any> }; additionalPrinterColumns?: Array<{ description?: string; format?: string; jsonPath: string; name: string; priority?: number; type: string }>; deprecated?: boolean; selectableFields?: Array<{ jsonPath: string }> }>;
/**
