...
* @isObject
*/
template: { spec?: Record<string, any>; metadata?: { annotations?: Record<string, any>; deletionGracePeriodSeconds?: number; name?: string; deletionTimestamp?: Date; generation?: number; managedFields?: Array<{ operation?: string; subresource?: string; time?: Date; apiVersion?: string; fieldsType?: string; fieldsV1?: Record<string, any>; manager?: string }>; ownerReferences?: Array<{ name: string; uid: string; apiVersion: string; blockOwnerDeletion?: boolean; controller?: boolean; kind: string }>; creationTimestamp?: Date; labels?: Record<string, any>; resourceVersion?: string; selfLink?: string; finalizers?: string[]; generateName?: string; namespace?: string; uid?: string } };
/**
