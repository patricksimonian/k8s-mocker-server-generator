...
* @isArray
*/
matchExpressions?: Array<{ scopeName: 'BestEffort' | 'CrossNamespacePodAffinity' | 'NotBestEffort' | 'NotTerminating' | 'PriorityClass' | 'Terminating'; values?: string[]; operator: 'DoesNotExist' | 'Exists' | 'In' | 'NotIn' }>;
}
