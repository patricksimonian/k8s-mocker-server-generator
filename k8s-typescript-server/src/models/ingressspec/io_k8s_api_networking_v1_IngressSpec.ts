...
* @isObject
*/
defaultBackend?: { resource?: { kind: string; name: string; apiGroup?: string }; service?: { name: string; port?: { name?: string; number?: number } } };
/**
...
* @isArray
*/
rules?: Array<{ host?: string; http?: { paths: Array<{ path?: string; pathType: 'Exact' | 'ImplementationSpecific' | 'Prefix'; backend: { resource?: { name: string; apiGroup?: string; kind: string }; service?: { name: string; port?: { name?: string; number?: number } } } }> } }>;
/**
