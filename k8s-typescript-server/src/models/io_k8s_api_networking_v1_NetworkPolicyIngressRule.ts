...
*/
from?: Array<{ podSelector?: { matchLabels?: Record<string, any>; matchExpressions?: Array<{ key: string; operator: string; values?: string[] }> }; ipBlock?: { cidr: string; except?: string[] }; namespaceSelector?: { matchExpressions?: Array<{ operator: string; values?: string[]; key: string }>; matchLabels?: Record<string, any> } }>;
/**
...
/**
* Create a new io_k8s_api_networking_v1_NetworkPolicyIngressRule with default values
*/
