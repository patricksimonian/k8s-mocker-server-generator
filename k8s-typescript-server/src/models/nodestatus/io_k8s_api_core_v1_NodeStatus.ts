...
* @isArray
*/
images?: Array<{ sizeBytes?: number; names?: string[] }>;
/**
...
* @isArray
*/
conditions?: Array<{ status: string; type: string; lastHeartbeatTime?: Date; lastTransitionTime?: Date; message?: string; reason?: string }>;
/**
...
* @isObject
*/
nodeInfo?: { machineID: string; operatingSystem: string; osImage: string; containerRuntimeVersion: string; kubeProxyVersion: string; kernelVersion: string; kubeletVersion: string; systemUUID: string; architecture: string; bootID: string };
/**
...
* @isArray
*/
runtimeHandlers?: Array<{ features?: { userNamespaces?: boolean; recursiveReadOnlyMounts?: boolean }; name?: string }>;
/**
...
export function createio_k8s_api_core_v1_NodeStatus(data?: Partial<io_k8s_api_core_v1_NodeStatus>): io_k8s_api_core_v1_NodeStatus {
 return {
   ...
   nodeInfo: data?.nodeInfo !== undefined ? data.nodeInfo : { kubeProxyVersion: '', machineID: '', operatingSystem: '', osImage: '', containerRuntimeVersion: '', bootID: '', kernelVersion: '', kubeletVersion: '', systemUUID: '', architecture: '' },
