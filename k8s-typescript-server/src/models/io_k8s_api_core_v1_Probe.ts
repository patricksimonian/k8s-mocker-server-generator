...
*/
httpGet?: { scheme?: 'HTTP' | 'HTTPS'; host?: string; httpHeaders?: Array<{ name: string; value: string }>; path?: string; port: string };
/**
...
/**
* Create a new io_k8s_api_core_v1_Probe with default values
*/
