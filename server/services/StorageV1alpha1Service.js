...
* returns Object
* */
const createStorageV1alpha1VolumeAttributesClass = ({ body, dryRun, fieldValidation }) => new Promise(
...
* returns Object
* */
const deleteStorageV1alpha1CollectionVolumeAttributesClass = ({ dryRun }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        dryRun,
...
* returns Object
* */
const deleteStorageV1alpha1VolumeAttributesClass = ({ name, dryRun }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const getStorageV1alpha1APIResources = () => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
      }));
...
* returns Object
* */
const listStorageV1alpha1VolumeAttributesClass = () => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
      }));
...
* returns Object
* */
const patchStorageV1alpha1VolumeAttributesClass = ({ name, dryRun, fieldValidation }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const readStorageV1alpha1VolumeAttributesClass = ({ name }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const replaceStorageV1alpha1VolumeAttributesClass = ({ name, body, dryRun, fieldValidation }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const watchStorageV1alpha1VolumeAttributesClass = ({ name }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* returns Object
* */
const watchStorageV1alpha1VolumeAttributesClassList = () => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
      }));
