...
* @isObject
*/
securityContext?: { fsGroupChangePolicy?: 'Always' | 'OnRootMismatch'; runAsGroup?: number; runAsNonRoot?: boolean; runAsUser?: number; seLinuxChangePolicy?: string; seLinuxOptions?: { level?: string; role?: string; type?: string; user?: string }; seccompProfile?: { localhostProfile?: string; type: 'Localhost' | 'RuntimeDefault' | 'Unconfined' }; appArmorProfile?: { localhostProfile?: string; type: 'Localhost' | 'RuntimeDefault' | 'Unconfined' }; supplementalGroupsPolicy?: 'Merge' | 'Strict'; sysctls?: Array<{ value: string; name: string }>; windowsOptions?: { gmsaCredentialSpec?: string; gmsaCredentialSpecName?: string; hostProcess?: boolean; runAsUserName?: string }; supplementalGroups?: number[]; fsGroup?: number };
/**
...
* @isArray
*/
tolerations?: Array<{ operator?: 'Equal' | 'Exists'; tolerationSeconds?: number; value?: string; effect?: 'NoExecute' | 'NoSchedule' | 'PreferNoSchedule'; key?: string }>;
/**
